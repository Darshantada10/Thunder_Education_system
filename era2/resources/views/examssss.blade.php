...
<script>
    ...
    if (count <= res.length) {
        ...
        if(element.id){
        // question =`<form  id="questionform" >
        // @csrf
        //     <h3>${element.question}</h3>
        //             <input type="radio" name="choice" id="choice1" value="${element.choice1}" value={{old('choice')}}>${element.choice1}<br>
        //             <input type="radio" name="choice" id="choice2" value="${element.choice2}" value={{old('choice')}}>${element.choice2}<br>
        //             <input type="radio" name="choice" id="choice3" value="${element.choice3}" value={{old('choice')}}>${element.choice3}<br>
        //             <input type="radio" name="choice" id="choice4" value="${element.choice4}" value={{old('choice')}}>${element.choice4}<br>
        //             <input type="hidden" name="quiz_id" value="${element.quiz_id}">
        //             <input type="hidden" name="question_id" value="${element.id}">
        //             <button  type="submit" id="myButton" onclick="savedata()">Next Question</button>
        //             </form>`;
